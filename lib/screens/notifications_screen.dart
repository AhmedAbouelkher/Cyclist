...
class NotificationsTap extends StatefulWidget {
  ...
  const NotificationsTap({Key key, this.prevWidget}) : super(key: key);
  @override
          ...
          children: <Widget>[
            Padding(
              ...
              child: Row(
                ...
                children: [
                  FaIcon(Icons.notifications, color: CColors.darkGreenAccent),
                  SizedBox(width: 10),
                  Text(trs.translate("notifications"), style: TextStyle(color: CColors.boldBlack, fontSize: 18)),
                ],
              ),
            ),
            Expanded(
